...
class CreateServiciosAdicionalesPedidosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('servicios_adicionales_pedidos', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('servicios_adicionales_pedidos');
    }
}
