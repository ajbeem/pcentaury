...
class CreatePromocionesPedidosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('promociones_pedidos', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->bigInteger('idPedido');
            $table->bigInteger('idPromocion');
    ...
    {
        Schema::dropIfExists('promociones_pedidos');
    }
}
